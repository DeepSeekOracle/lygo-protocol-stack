...
| -------------- | -------- | ------------ | ----- | ------------------------------- | ------------------ |
| lygo-continuum | high     | dynamic-tool | -     | definePluginEntry, registerTool | tools              |
...
| -------------- | ----------------------- | ----- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------- |
| lygo-continuum | seam-inventory          | log   | observed 0 hooks, 2 registrations, and 1 manifest contracts                           | registration:definePluginEntry, registration:registerTool, manifestContract:tools | -             |
| lygo-continuum | hook-names-present      | log   | all observed hooks exist in the target OpenClaw hook registry                         | -                                                                                 | -             |
| lygo-continuum | api-registrars-present  | log   | all observed api.register* calls exist in the target OpenClaw plugin API builder      | registerTool                                                                      | -             |
| lygo-continuum | sdk-exports-present     | log   | all observed plugin SDK imports exist in target OpenClaw package exports              | openclaw/plugin-sdk/plugin-entry                                                  | -             |
| lygo-continuum | manifest-fields-checked | log   | plugin manifest fields were compared with target OpenClaw manifest types              | openclaw.plugin.json                                                              | -             |
| lygo-continuum | package-metadata        | log   | selected package metadata for plugin contract checks                                  | package.json, @deepseekoracle/lygo-continuum, version:1.0.0                       | -             |
| lygo-continuum | declarative-contracts   | log   | fixture declares manifest contracts that can be checked without executing plugin code | tools                                                                             | -             |
