...
**Immutable Anchor (Biophase7):** [`docs/ANCHOR_DEPLOYMENT.md`](docs/ANCHOR_DEPLOYMENT.md) — local CA + Arweave Turbo + SLM/P7 hooks + autonomous worker. ClawHub skill: [`lygo-immutable-anchor`](https://clawhub.ai/deepseekoracle/lygo-immutable-anchor) (`docs/skills/lygo-immutable-anchor/`).  
