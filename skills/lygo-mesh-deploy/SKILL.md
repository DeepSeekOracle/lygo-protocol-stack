...
**Layer D semantic layer:** install [lygo-living-mesh](https://clawhub.ai/deepseekoracle/skills/lygo-living-mesh) for A/B/C root badges + sentinel (`docs/LIVING_MESH_LAYER.md`). This skill is the **transport**; living-mesh is the **lattice root gossip contract**.
...
- Pair with Layer D: `python tools/verify_living_mesh.py --json --run-sim`.
