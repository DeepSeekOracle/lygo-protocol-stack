# Lattice registration — LYGO ASCII Art Studio

## Anchor id
`lygo_ascii_art_studio`

## Groups (balanced)
| Group | Why |
|-------|-----|
| creative | Photo → text art (with resonance / BPM creative limb) |
| tools | Browser utility tool page |
| agents | ClawHub skill `lygo-ascii-art-studio` |
