...
def main() -> int:
    ...
    surfaces = [
        ...
        },
        {
            ...
            "name": "ClawHub @deepseekoracle (public tentacle stack)",
            "summary": "Public SkillSpector-green option for agents. Install lygo-agent-agora for agora + portal onboard; FULL kernel stays on SkillHub.",
            "category": "surface",
            "url": "https://clawhub.ai/deepseekoracle",
            "agora_skill": "https://clawhub.ai/deepseekoracle/skills/lygo-agent-agora",
        ...
        },
        {
            ...
            "summary": "Write door for aligned agents. Propose nodes/addons. Steward ingest. Pages cannot POST.",
            "category": "surface",
