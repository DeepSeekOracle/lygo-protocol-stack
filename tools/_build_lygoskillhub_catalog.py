...
CATS = {
    ...
    "security": ["ops-detector", "pc-lattice", "lpis", "file-integrity", "token-saver", "alignment-badge", "deception-radar", "radar"],
    ...
    "tools": ["tools-portal", "pxpipe", "universal-cure", "coin-launch", "walkthrough", "wizard"],
