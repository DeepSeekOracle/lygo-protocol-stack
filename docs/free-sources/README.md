...
Catalog v1.10.0. Portal only. No XXX catalog. All ages / Kids / 18+ gated shelves. Channel tab is steward rooms. Other bouquets probed 2026-09-05 (HTTP 200, ≥3 HTTPS entries). Steward rules: `CATALOG.md`.
